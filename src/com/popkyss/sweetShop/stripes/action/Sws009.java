...
import com.popkyss.sweetShop.stripes.bean.Sws009Bean;
...
@UrlBinding("/sws009.action")
public class Sws009 extends ASessionActionSupport<Sws009Bean> {

	private static final String CURRENT_JSP = "/jsp/sweetShop/sws009.jsp";
	...
	public Sws009Bean getActionBean() {
		return actionBean;
	}

	public void setActionBean(Sws009Bean actionBean) {
